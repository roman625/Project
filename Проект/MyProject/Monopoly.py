...
place_player = {'0': ['2', '3', '1'], '1': [], '2': [], '3': [], '4': [], '5': [], '6': [], '7': [],
...
class Board:
    ...
    def dice_roll(self, screen):
        global player2_cash, player1_cash, player3_cash, play
        self.roll = random.choice([1, 2, 3, 4, 5, 6]) + random.choice([1, 2, 3, 4, 5, 6])
        if self.player1_roll == self.player3_roll:
            play = '1'
            self.player1_roll += 1
        elif self.player1_roll > self.player2_roll:
            play = '2'
            self.player2_roll += 1
        elif self.player2_roll > self.player3_roll:
            play = '3'
            self.player3_roll += 1
...
def playing_field():
    try:
        ...
        text6 = f1.render('Информация о игроках', 1, (0, 0, 0))
        text7 = f1.render('Информация о улице', 1, (0, 0, 0))
